...
export declare class GiftCards {
     ...
     */
    list(request?: Square.GiftCardsListRequest, requestOptions?: GiftCards.RequestOptions): Promise<core.Page<Square.GiftCard>>;
    /**
     ...
     *     })
     */
    get(request: Square.GiftCardsGetRequest, requestOptions?: GiftCards.RequestOptions): Promise<Square.GetGiftCardResponse>;
