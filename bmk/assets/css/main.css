...
/* Button */
	...
	.button {
		...
		button:hover,
		.button:hover {
			box-shadow: inset 0 0 0 1px rgba(164, 90, 82, 0.6);
			background-color: rgba(164, 90, 82, 1);
		...
		.button:active {
			...
			box-shadow: inset 0 0 0 1px rgba(22, 184, 243, 0.7);
			color: rgba(22, 184, 243, 0.7) !important;
		}
...
/* Form */
	...
	textarea {
		...
		select:focus,
		textarea:focus {
			border-color: rgba(22, 184, 243, 0.7);
			box-shadow: 0 0 0 1px rgba(22, 184, 243, 0.7);
		}
...
/* Icon */
	...
	a.icon.style2:hover:before {
		box-shadow: inset 0 0 0 1px #a45a52;
		color: #a45a52;
	}
...
/* Spotlight (style1) */
	...
	.spotlight.style1:nth-child(odd), #locations {
		background-color: rgba(22, 184, 243, 0.7)
	}
    ...
    .spotlight.style1 .image {
        ...
        .spotlight.style1 .image:hover {
            box-shadow: 0 20px 40px -10px rgba(0, 6, 177, 0.5);
        }
        ...
        .spotlight.style1 .image:hover img {
...
@media screen and (max-width: 736px) and (orientation: portrait) {
    ...
    ul.benefits li:not(:last-child)::after {
        content: "ᨒ";
        margin-left: 1.5rem;
        color: inherit;
    }
	...
	.gallery.style2 {
		...
		.gallery.style2 article {
			...
			.gallery.style2 article .caption {
				...
				width: 100%;
				height: 100%;
				background-color: var(--flavor-color, rgba(0, 0, 0, 0.5));
				color: #ffffff;
				text-shadow:
