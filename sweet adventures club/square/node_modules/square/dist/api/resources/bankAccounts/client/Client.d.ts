...
export declare class BankAccounts {
     ...
     */
    list(request?: Square.BankAccountsListRequest, requestOptions?: BankAccounts.RequestOptions): Promise<core.Page<Square.BankAccount>>;
    /**
     ...
     *     })
     */
    getByV1Id(request: Square.BankAccountsGetByV1IdRequest, requestOptions?: BankAccounts.RequestOptions): Promise<Square.GetBankAccountByV1IdResponse>;
    /**
     ...
     *     })
     */
    get(request: Square.BankAccountsGetRequest, requestOptions?: BankAccounts.RequestOptions): Promise<Square.GetBankAccountResponse>;
