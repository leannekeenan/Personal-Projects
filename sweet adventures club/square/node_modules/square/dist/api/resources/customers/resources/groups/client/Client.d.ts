...
export declare class Groups {
     ...
     */
    list(request?: Square.customers.GroupsListRequest, requestOptions?: Groups.RequestOptions): Promise<core.Page<Square.CustomerGroup>>;
    /**
     ...
     *     })
     */
    get(request: Square.customers.GroupsGetRequest, requestOptions?: Groups.RequestOptions): Promise<Square.GetCustomerGroupResponse>;
    /**
     ...
     *     })
     */
    delete(request: Square.customers.GroupsDeleteRequest, requestOptions?: Groups.RequestOptions): Promise<Square.DeleteCustomerGroupResponse>;
    /**
     ...
     *     })
     */
    add(request: Square.customers.GroupsAddRequest, requestOptions?: Groups.RequestOptions): Promise<Square.AddGroupToCustomerResponse>;
    /**
     ...
     *     })
     */
    remove(request: Square.customers.GroupsRemoveRequest, requestOptions?: Groups.RequestOptions): Promise<Square.RemoveGroupFromCustomerResponse>;
