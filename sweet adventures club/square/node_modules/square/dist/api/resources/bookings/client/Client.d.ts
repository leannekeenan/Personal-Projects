...
export declare class Bookings {
     ...
     */
    list(request?: Square.BookingsListRequest, requestOptions?: Bookings.RequestOptions): Promise<core.Page<Square.Booking>>;
    /**
     * Creates a booking.
     *
     ...
     *     })
     */
    get(request: Square.BookingsGetRequest, requestOptions?: Bookings.RequestOptions): Promise<Square.GetBookingResponse>;
    /**
     * Updates a booking.
     *
     * To call this endpoint with buyer-level permissions, set `APPOINTMENTS_WRITE` for the OAuth scope.
