...
export declare class Segments {
     ...
     */
    list(request?: Square.customers.SegmentsListRequest, requestOptions?: Segments.RequestOptions): Promise<core.Page<Square.CustomerSegment>>;
    /**
     ...
     *     })
     */
    get(request: Square.customers.SegmentsGetRequest, requestOptions?: Segments.RequestOptions): Promise<Square.GetCustomerSegmentResponse>;
