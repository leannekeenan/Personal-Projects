...
import { RetrieveTokenStatusResponse } from '../models/retrieveTokenStatusResponse';
...
export declare class OAuthApi extends BaseApi {
     ...
     * @return Response from the API call
     */
    retrieveTokenStatus(authorization: string, requestOptions?: RequestOptions): Promise<ApiResponse<RetrieveTokenStatusResponse>>;
}
